...
#define osset tree<ll,null_type,less<ll>,rb_tree_tag,tree_order_statistics_node_update>
#define int ll
...
void solve()
{
    ...
    {
        string cad1=cad.substr(0,t/2);
        string cad2=cad.substr(t/2,t/2);
        cout<<(cad1==cad2?"YES\n":"NO\n");
    }
}
main()
