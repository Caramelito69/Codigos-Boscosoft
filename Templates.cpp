...
#define osset tree<ll,null_type,less<ll>,rb_tree_order_statistics_node_update>
#define int ll
...
template<typename T> T sumar(T a,T b)
{
    return a+b;
}
void solve()
